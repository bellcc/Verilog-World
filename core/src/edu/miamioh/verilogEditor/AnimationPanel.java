...
public class AnimationPanel extends JPanel {
	...
	URL imageURL = AnimationPanel.class
		.getResource("images/animationImage.png");
	...
	for (int i = 0; i < 8; i++) {
	    cb[i].setPreferredSize(new Dimension((int) (this.getWidth() / 4.0),
		    (int) (this.getHeight() / 4.0)));
	}
    }
...
class MyMouseListener implements MouseListener {
    ...
    public MyMouseListener(JFormattedTextField simulateInput,
