...
import edu.miamioh.worldSimulator.OptionStage.Actors.ChangeListeners.SimulateChangeListener;

public class SimulateActor extends AbstractGameObject{

	public TextButton button;
	public String buttonText;
	public Color color;
	
	public SimulateActor() {
		...
		button.addListener(new SimulateChangeListener());
