...
import edu.miamioh.worldSimulator.OptionStage.Actors.ChangeListeners.ResetChangeListener;

public class ResetActor extends AbstractGameObject{
	...
	public ResetActor() {
		...
		button.addListener(new ResetChangeListener());
