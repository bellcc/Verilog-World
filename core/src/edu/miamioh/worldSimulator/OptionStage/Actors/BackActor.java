...
import edu.miamioh.worldSimulator.OptionStage.Actors.ChangeListeners.BackChangeListener;

public class BackActor extends AbstractGameObject{
	...
	public BackActor() {
		...
		button.addListener(new BackChangeListener());
